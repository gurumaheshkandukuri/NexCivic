...
export default function LandingHero({ issues, users, setActiveTab, user, theme = "dark" }: LandingHeroProps) {
  ...
  const activeCitizensCount = users.filter(u => u.role === "Citizen").length || 320; 
